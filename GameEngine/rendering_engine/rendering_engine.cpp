...
GameEngine::RenderingEngine::RenderingEngine::RenderingEngine(
...
void GameEngine::RenderingEngine::RenderingEngine::render(Scene& scene) {
...
void GameEngine::RenderingEngine::RenderingEngine::renderMeshWithAllRequiredShaders(
...
void GameEngine::RenderingEngine::RenderingEngine::renderMesh(
    const shared_ptr<CameraComponent>& camera,
    const shared_ptr<OpenGLMeshRendererComponent>& meshRenderer,
...
void GameEngine::RenderingEngine::RenderingEngine::traverseSceneHierarchy(GameObject& gameObject, const function<void(GameObject&)>& callback) {
    callback(gameObject);
...
void GameEngine::RenderingEngine::RenderingEngine::pushOpenGLState(const OpenGLState& state) {
    applyOpenGLState(state);
    m_openGLStateStack.push(state);
}

void GameEngine::RenderingEngine::RenderingEngine::popOpenGLState() {
...
void GameEngine::RenderingEngine::RenderingEngine::applyOpenGLState(const OpenGLState& state) {
...
void GameEngine::RenderingEngine::RenderingEngine::putMeshInGeometryBuffersIfNecessary(const string& name, const Mesh& mesh) {
...
void GameEngine::RenderingEngine::RenderingEngine::setupOpenGL() {
